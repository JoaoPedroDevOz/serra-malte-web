...
cliente_id BIGINT(10) PRIMARY KEY,
tipo_pessoa_id BIGINT(1),
...
tipo_pessoa_id BIGINT(1) PRIMARY KEY,
tipo VARCHAR(20)
)

CREATE TABLE tbl_pedido (
pedido_id BIGINT(10) PRIMARY KEY,
status_pedido_id BIGINT(2),
cliente_id BIGINT(10),
data_hora_pedido DATETIME,
FOREIGN KEY(cliente_id) REFERENCES tbl_cliente (cliente_id)
)

CREATE TABLE tbl_status_pedido (
status_pedido_id BIGINT(2) PRIMARY KEY,
status VARCHAR(20)
)

CREATE TABLE tbl_tipo_produto (
tipo_produto_id BIGINT(2) PRIMARY KEY,
tipo VARCHAR(100)
)

CREATE TABLE tbl_produto (
produto_id BIGINT(10) PRIMARY KEY,
tipo_produto_id BIGINT(2),
nome VARCHAR(100),
...
tipo_ingrediente_id BIGINT(10) PRIMARY KEY,
tipo VARCHAR(30)
)

CREATE TABLE tbl_ingrediente (
ingrediente_id BIGINT(10) PRIMARY KEY,
tipo_ingrediente_id BIGINT(3),
nome VARCHAR(50),
FOREIGN KEY(tipo_ingrediente_id) REFERENCES tbl_tipo_ingrediente (tipo_ingrediente_id)
)

CREATE TABLE tbl_fornecedor (
fornecedor_id BIGINT(10) PRIMARY KEY,
email VARCHAR(320),
contato VARCHAR(100),
telefone VARCHAR(15),
nome VARCHAR(200),
...
endereco_id BIGINT(10) PRIMARY KEY,
cliente_id BIGINT(10),
